...
static USBD_CDC_LineCodingTypeDef linecoding = {115200, 0x00, 0x00, 0x08};
...
static int8_t CDC_Control_FS(uint8_t cmd, uint8_t* pbuf, uint16_t length)
{
    ...
    switch (cmd) {
        ...
        case CDC_SET_LINE_CODING:
            ...
            pbuf[0] = (linecoding.bitrate >> 24U) & 0xFFU;
            pbuf[1] = (linecoding.bitrate >> 16U) & 0xFFU;
            pbuf[2] = (linecoding.bitrate >> 8U) & 0xFFU;
            pbuf[3] = (linecoding.bitrate) & 0xFFU;
            pbuf[4] = linecoding.format & 0xFFU;
            pbuf[5] = linecoding.paritytype & 0xFFU;
            pbuf[6] = linecoding.datatype & 0xFFU;
        ...
        case CDC_GET_LINE_CODING:
            ...
            linecoding.bitrate =
                (((pbuf[0] & 0xFFU) << 24U) | ((pbuf[1] & 0xFFU) << 16U) |
                 ((pbuf[2] & 0xFFU) << 8U) | (pbuf[3] & 0xFFU));
            linecoding.format = pbuf[4] & 0xFFU;
            linecoding.paritytype = pbuf[5] & 0xFFU;
            linecoding.datatype = pbuf[6] & 0xFFU;
